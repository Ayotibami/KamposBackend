...
import spotsAdminRoutes from './modules/idiot/spots.routes';
...
import spotRoutes from './modules/spot/spot.routes';
import spotCommentRoutes from './modules/spot-comment/spot-comment.routes';
...
app.use('/api/v1/spot-comments', spotCommentRoutes);
...
app.use('/api/v1/idiot/spots', spotsAdminRoutes);
